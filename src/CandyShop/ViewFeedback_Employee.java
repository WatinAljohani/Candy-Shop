 ...
 * @author twin1
 */
public class ViewFeedback_Employee extends javax.swing.JFrame {
    ...
    public ViewFeedback_Employee() {
        super("Employee: View Feedback");
        initComponents();
        init();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFeedback_Employee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewFeedback_Employee().setVisible(true);
            }
        });
    }
